sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("my/oft/jul/mygitDemo/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("my.oft.jul.mygitDemo.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["my/oft/jul/mygitDemo/localService/mockserver"], function (mockserver) {
