sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("my.oft.jul.mygitDemo.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias my.oft.jul.mygitDemo.controller.ListSelector
			 */
			 ...
			 * @return {my.oft.jul.mygitDemo.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
